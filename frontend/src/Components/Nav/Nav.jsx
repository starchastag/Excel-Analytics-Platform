    ...
    <>
      <nav className="bg-white border-gray-200 dark:bg-gray-900 dark:border-gray-700">
        <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
          ...
          >
            <img
              src="https://www.shutterstock.com/shutterstock/photos/1954825816/display_1500/stock-vector-digital-technology-social-network-global-connect-simple-business-logo-black-icon-on-white-1954825816.jpg"
              className="h-8"
              alt="Flowbite Logo"
            />
